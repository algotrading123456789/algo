...
# Define the function for your script
...
def update_github_file():
    ...
    content_base64 = base64.b64encode(script_content.encode()).decode()
    ...
    if response.status_code == 200:
        ...
        print(f"Failed to update file on GitHub. Status code: {response.status_code}")

# Schedule the job
schedule.every(5).to(10).minutes.do(update_github_file)

while True:
    # Run the scheduled job
    schedule.run_pending()
    
    # Execute the trades analysis function
    run_trades_analysis()
